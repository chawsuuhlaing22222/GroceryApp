...
object RealtimeDatabaseFirebaseApiImpl : FirebaseApi {
    ...
    override fun getGroceries(
        ...
        database.child("grocery").addValueEventListener(object : ValueEventListener {
    ...
    override fun addGrocery(name: String, description: String, amount: Int) {
        ...
        database.child("grocery").child(name).setValue(GroceryVO(name,description,amount))
    }

    override fun deleteGrocery(name: String) {
        database.child("grocery").child(name).removeValue()
    }
}